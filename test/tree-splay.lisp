...
(define-test splay-tree/make-tree
  (let ((tree (tree:make-tree 'tree:splay-tree)))
    (of-type tree:splay-tree tree)
    (false (tree::root tree))
    (is eq #'identity (tree::key tree))
    (is eq #'< (tree::test tree))))

(define-test splay-tree/walk
  (let ((tree (tree:make-tree 'tree:splay-tree))
...
(define-test splay-tree/find
  (let ((tree (tree:make-tree 'tree:splay-tree)))
    ...
    (setf tree (tree:make-tree 'tree:splay-tree :key #'cdr))
...
(define-test splay-tree/previous
  (let ((tree (tree:make-tree 'tree:splay-tree)))
    (dotimes (i 100)
      (tree:insert tree (1+ i)))
